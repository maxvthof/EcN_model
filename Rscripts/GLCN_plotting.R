...
X95 <- read.csv('glcn_flux_pred_0.95.csv')
X96 <- read.csv('glcn_flux_pred_0.96.csv')
X97 <- read.csv('glcn_flux_pred_0.97.csv')
X98 <- read.csv('glcn_flux_pred_0.98.csv')
X99 <- read.csv('glcn_flux_pred_0.99.csv')
X90 <- read.csv('glcn_flux_pred_0.9.csv')
...
ggplot(data = X99, aes(x=model_id, ymin = silico_LB, ymax = silico_UB))+
  ...
  scale_colour_manual("", 
                      ...
                      values = c("#b7eddf","#9ad9c9", "#7cc6b4", "#5eb29f","#3c9f8b","#008c77",'black'),
                      labs('FVA threshold'))+
...
#import pFBA
pfba <- read.csv('glcn_flux_pred_pfba.csv')
...
ggplot(data = X99, aes(x=model_id, ymin = silico_LB, ymax = silico_UB))+
  ...
  scale_colour_manual("", 
                      ...
                      values = c("#b7eddf","#9ad9c9", "#7cc6b4", "#5eb29f","#3c9f8b","#008c77",'grey', 'black'),
